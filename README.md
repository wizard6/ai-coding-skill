...
**AI Coding 编程规范** — Cursor 个人/团队可安装的 Agent Skill（当前 **v1.35**）。

用于：依赖向内、索引驱动、效果/功能锁、先确认后改、沟通语言层级 L1–L4、纪律化回复（7.29）、会话 memory（7.30：SSOT/经验/日志）、量级省耗、固定运维脚本化、事毕复盘等。  
触发：项目编码，或提及「编程规范 / 表述 / 先确认 / @ai-coding / @grounded-reply」。
